...
Drag the *Filter Reference* processor to the canvas, click the green plus sign to configure the filter, and click a filter type from the *Choose Global Type* menu. 

image:filter-types.png[filter-types]

For more information, see  link:/mule-user-guide/v/3.9/filter-ref[Filter Reference].
